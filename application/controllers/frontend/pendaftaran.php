...
class pendaftaran extends CI_Controller {
  ...
  public function __construct() 
    ...
    $form_open = form_open_multipart('frontend/pendaftaran/addaction', $attr_form);
    ...
    foreach ($get_event as $s) {
        ...
        $fe_nama = form_error('nama_peserta');
        $submit = form_submit('Simpan', 'DAFTAR', $attr_submit);
        ...
        'isi'  => 'frontend/pendaftaran_peserta/pendaftaran_peserta_form'
        );
  ...
  public function addaction()
  {
              ...
              $this->session->set_flashdata('succes', 'Pendaftaran Berhasil, Cek Data Anda di Menu Daftar Peserta');
              redirect('frontend/daftar_peserta');
