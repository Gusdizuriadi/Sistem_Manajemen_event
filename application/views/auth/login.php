                ...
                <div class="row align-items-center">
                    <div class="col-md-6 mb-5">
                        <div class="card-body">
                            ...
                            <img src="<?php echo base_url() ?>assets/backend/template/assets/images/.png" alt="" class="img-fluid mb-4">
                            <h5 class="mb-3 f-w-900">Silahkan Login</h5>
                            ...
                            <div class="">
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-caption d-none d-md-block">
                                        <img src="<?php echo base_url() ?>assets/backend/template/assets/images/product/irpi.png" alt="product images" class="img-fluid mb-5">
                                        <h5>ADMINISTRATOR INSTITUTE RESEARCH AND PUBLICATION INDONESIA </h5>
                                    </div>
                               </div>
                           </div>
                        </div>
